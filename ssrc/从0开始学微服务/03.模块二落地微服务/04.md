...
* Tars：腾讯内部使用的RPC框架，于2017年对外开源，仅支持C加加语言。

* Spring Cloud：国外Pivotal公司2014年对外开源的RPC框架，仅支持Java语言，最近几年生态发展得比较好，是比较火的RPC框架。

而跨语言平台的开源RPC框架主要有以下几种。

* gRPC：Google于2015年对外开源的跨语言RPC框架，支持常用的C加加、Java、Python、Go、Ruby、PHP、Android Java、Objective-C等多种语言。

* Thrift：最初是由Facebook开发的内部系统跨语言的RPC框架，2007年贡献给了Apache基金，成为Apache开源项目之一，支持常用的C加加、Java、PHP、Python、Ruby、Erlang等多种语言。
...
![](./httpsstatic001geekbangorgresourceimage71f37114e779d5e8a20ad9986b8ebc52f2f3.jpg)  
...
![](./httpsstatic001geekbangorgresourceimage081908044dcbdbaaedb30222695be29bc119.jpg)  
...
Tars是腾讯根据内部多年使用微服务架构的实践，总结而成的开源项目，仅支持C加加语言，它的架构图如下。

![](./httpsstatic001geekbangorgresourceimagee298e207486467e03ded669380f39aadf098.png)  
...
![](./httpsstatic001geekbangorgresourceimaged701d71df127a2c40acf06b3fba6deb42501.png)  
...
很显然，如果你的语言平台是C加加，那么只能选择Tars；而如果是Java的话，可以选择Dubbo、Motan或者Spring Cloud。这时你又要问了，它们三个又该如何抉择呢？
...
![](./httpsstatic001geekbangorgresourceimaged9f9d9acfb00d5e98adbd65306e6a4e761f9.png)  
...
![](./httpsstatic001geekbangorgresourceimaged562d5c959122758f1915d6ae4f89247e062.png)  
