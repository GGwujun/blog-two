...
我们知道，目前HotSpot虚拟机的绝大部分代码都是用C加加写的。这也造就了一个非常有趣的现象，那便是对Java语言本身的贡献需要精通C加加。此外，随着HotSpot项目日渐庞大，维护难度也逐渐上升。
...
Metropolis项目将运用SubstrateVM项目，逐步地将HotSpot虚拟机中的C加加代码替换成Java代码，从而提升HotSpot虚拟机的可维护性，也加快新Java功能的开发效率。
